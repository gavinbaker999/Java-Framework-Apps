...
public class msgQueue {
			...
			msgQueue(String name,String desc) {
				...
				String data = supportFunctions.getDBConn().executeSQLQuery("SELECT MAX(ehsmsgserverID) FROM ehsmsgservers","-1");
			...
			public void setMsg(String msgQueue,String msg) {
				...
				supportFunctions.getDBConn().executeSQLQuery("INSERT INTO ehsmsgservers (ehsmsgserversID,ehsmsgserverQueue,ehsmsgserversMsg) VALUES (null,'" + msgQueue + "','" + msg + "')","");
			}
			public String getMsg(String msgQueue) {
				if (target != null) {target.msgGet(msgQueue);}	
				
				String data = supportFunctions.getDBConn().executeSQLQuery("SELECT FROM ehsmsgservers ehsmsgserverID,ehsmsgserverMsg WHERE ehsmsgserverQueue='" + msgQueue + "' AND ehsmsgserverID>" + String.valueOf(currentMsgID) + " LIMIT 1","");
				if (data.length() > 0) {
			...
			public void deleteMsgQueue(String msgQueue) {
				...
				supportFunctions.getDBConn().executeSQLQuery("DELETE FROM ehsmsgservers WHERE ehsmsgserverQueue='" + msgQueue + "'","");
			}
		}
